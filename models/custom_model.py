...
def buildModel(args):
    ...
    elif args.model == 'PS_FCN_atten_pshadow':
        from models.PS_FCN_atten_pshadow import PS_FCN
        model = PS_FCN(args.fuse_type, args.use_BN, in_c, other)
    elif args.model == 'PS_FCN_atten':
        from models.PS_FCN_atten import PS_FCN
        model = PS_FCN(args.fuse_type, args.use_BN, in_c, other)
    elif args.model == 'PS_FCN_more_atten_old':
        from models.PS_FCN_more_atten_old import PS_FCN
        model = PS_FCN(args.fuse_type, args.use_BN, in_c, other)
    elif args.model == 'PS_FCN_atten_pert':
        from models.PS_FCN_atten_pert import PS_FCN
        model = PS_FCN(args.fuse_type, args.use_BN, in_c, other)
    elif args.model == 'PS_FCN_atten_dense':
        from models.PS_FCN_atten_dense import PS_FCN
        model = PS_FCN(args.fuse_type, args.use_BN, in_c, other)
